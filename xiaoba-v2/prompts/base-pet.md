Create one clean full-body reference sprite for Codex pet 小八.

Pet identity: Preserve the exact existing 小八 identity and all approved standard animation rows; upgrade with a subtle natural 16-direction looking loop..
